 ...
 * @author Mary
 */
public class TelaListarFornecedor extends javax.swing.JInternalFrame {

    FornecedorRepositorio dao = GerenciadorReferencias.getFornecedor();
    TelaEditarFornecedor editar;
    ...
    public void buscar(String nome) {
        Fornecedor filtro = new Fornecedor(0, null, nome, null, null);
    ...
    private void tblBuscaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblBuscaMouseClicked
        ...
        editarFornecedor(id);// TODO add your handling code here:
    ...
    public void editarFornecedor(int codigo) {
        ...
        editar = new TelaEditarFornecedor();
